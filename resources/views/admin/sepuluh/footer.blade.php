...
<footer>
 ...
 <!-- end footer -->
 <!-- Javascript files-->
 <script src="{{ asset('sepuluh/js/jquery.min.js') }}"></script>
 <script src="{{ asset('sepuluh/js/bootstrap.bundle.min.js') }}"></script>
 <script src="{{ asset('sepuluh/js/jquery-3.0.0.min.js') }}"></script>
 <!-- sidebar -->
 <script src="{{ asset('sepuluh/js/jquery.mCustomScrollbar.concat.min.js') }}"></script>
 <script src="{{ asset('sepuluh/js/custom.js') }}"></script>
</body>
</html>